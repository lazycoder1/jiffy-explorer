[
    {
        inputs: [
            { internalType: "address", name: "_create2factory", type: "address" },
            { internalType: "uint256", name: "_paymasterStake", type: "uint256" },
        ...
        inputs: [
            {
                components: [
                    ...
                    { internalType: "uint256", name: "callGas", type: "uint256" },
                    { internalType: "uint256", name: "verificationGas", type: "uint256" },
    ...
    },
    {
        ...
        outputs: [{ internalType: "uint256[]", name: "senderStorageCells", type: "uint256[]" }],
        stateMutability: "view",
        type: "function",
    },
    {
        ...
        inputs: [
            ...
            },
            {
                components: [
                    ...
                    { internalType: "enum EntryPoint.PaymentMode", name: "paymentMode", type: "uint8" },
